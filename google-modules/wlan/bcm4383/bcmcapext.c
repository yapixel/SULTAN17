...
static const capext_bitpos_to_string_map_t capext_wl_features_subfeature_map[] = {
	...
	CAPEXT_SUBFEATURE_MAP(WLC_CAPEXT_FEATURE_BITPOS_MRSNO_AP, "mrsno_ap"),
	CAPEXT_SUBFEATURE_MAP(WLC_CAPEXT_FEATURE_BITPOS_CSI_DMA, "csi_dma"),
	CAPEXT_SUBFEATURE_MAP(WLC_CAPEXT_FEATURE_BITPOS_LPCAP, "lpcap"),
