...
/**
 * gxp_domain_pool_init() - Initializes a domain pool.
 ...
 */
int gxp_domain_pool_init(struct gxp_dev *gxp, struct gcip_domain_pool *pool, unsigned int size);
...
void gxp_domain_pool_free(struct gcip_domain_pool *pool, struct gcip_iommu_domain *gdomain);
