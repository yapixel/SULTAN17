							       ...
							       struct shrink_control *sc)
{
	...
	WARN(in_atomic(),
	     ...
	     "This may not originate from the GPU driver even though the final warning is printed here."
	     "Please check the callstack for who the actual culprit is and route the bug accordingly!",
	     sc->gfp_mask);
