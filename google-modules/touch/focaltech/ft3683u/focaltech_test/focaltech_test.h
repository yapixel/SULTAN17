...
struct mc_sc_threshold_b {
    ...
    int scap_rawdata_off_min_ical;
    int scap_rawdata_off_max_ical;
    int scap_rawdata_wp_off_check;
    int scap_rawdata_on_min;
    int scap_rawdata_on_max;
    int scap_rawdata_on_min_ical;
    int scap_rawdata_on_max_ical;
...
struct mc_sc_threshold {
    ...
    int *rawdata_h_min;
    int *rawdata_h_max;
    int *rawdata_h_min_ical;
    int *rawdata_h_max_ical;
    int *rawdata_l_min;
    int *rawdata_l_max;
    ...
    int *tx_linearity_max_ical;
    int *tx_linearity_min_ical;
    int *rx_linearity_max_ical;
    int *rx_linearity_min_ical;
    int *scap_cb_off_min;
    int *scap_cb_off_max;
    int *scap_cb_on_min;
    int *scap_cb_on_max;
